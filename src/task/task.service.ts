...
- "purpose": Brief description (e.g. "Task 1 Postcard context").
      ...
      "contextRegions": [
        {
          ...
          "purpose": "Task 1 reading passage",
          "confidence": "HIGH"
        }
      ]
    }
  ...
  "questions": [
    {
      ...
      "confidence": "HIGH",
      "evidence": "Found in the top header: '12th October'",
      "config": {
    ...
    },
    {
      ...
      "answerState": "AI_SOLVED",
      "confidence": "HIGH",
      "evidence": "Opening hours say 'Monday to Saturday only'",
      "config": {
        "options": ["True", "False"],
        "correctIndex": 1,
        "answer": "False"
    ...
    },
    {
      ...
      "answerState": "AI_SOLVED",
      "confidence": "HIGH",
      "evidence": "Notice says Doctor James is in on Tuesdays",
      "config": {
        "options": [],
        "correctIndex": null,
        "answer": "Tuesday"
    ...
    },
    {
      ...
      "answerState": "AI_SOLVED",
      "confidence": "HIGH",
      "evidence": "Listed under contact info at the bottom",
      "config": {
